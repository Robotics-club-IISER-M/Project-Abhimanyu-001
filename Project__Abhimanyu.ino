...
// address we will assign for all 3 sensor
...
//Function to initallize the sensors ids
void setID() {
...
// Function to read sensor for LIDAR values
void readSensor() {
  // Read the front LiDAR sensor
  LFSensorValue = sensor.readDistance1();
  // Read the front LiDAR sensor
  RFSensorValue = sensor.readDistance1();
  // Read the left LiDAR sensor
  leftSensor =  sensor.readDistance2();
  // Read the right LiDAR sensor
  rightSensor = sensor.readDistance3();
}
